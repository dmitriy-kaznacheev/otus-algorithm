...
* обычные итерации `itr_pow`
* степень двойки с домножением `two_pow`
* двоичное разложение показателя степени `bin_pow`
...
* рекурсия `recursion`
* итерации `iterative`
* формула золотого сечения `golden_ratio`
* возведение матрицы в степень `matrix_multiply`
